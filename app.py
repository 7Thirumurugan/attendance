...
#adding email is not any through is good  working contidion
...
# SENDER_EMAIL = "thirumahi65@gmail.com"
# SENDER_PASSWORD = "rewx fnfo jqou ppxw"   # Your Gmail App Password

# def send_email_notification(to_email, student_name, status, time_str):
...
#     mail = db.Column(db.String(50))   # <-- ADDED EMAIL COLUMN
...
#                         # ---------------------------
#                         # SEND EMAIL USING student.mail
#                         # ---------------------------
#                         if student and student.mail and "@" in student.mail:
...
#                         # ---------------------------
#                         # SEND WHATSAPP USING student.phone
#                         # ---------------------------
#                         if student and student.phone:
#                             raw = student.phone.strip()
#                             if not raw.startswith("+") and "@" not in raw:
#                                 digits = ''.join(ch for ch in raw if ch.isdigit())
#                                 phone = f"+91{digits}" if len(digits) == 10 else raw
#                             else:
#                                 phone = raw
...
#     students = Student.query.all()
#     result = [
#         {"id": s.id, "name": s.name, "rollno": s.rollno, "phone": s.phone, "mail": s.mail}
#         for s in students
#     ]
#     return jsonify(result)
...
#     student.rollno = data.get("rollno", student.rollno)
#     student.phone = data.get("phone", student.phone)
#     student.mail = data.get("mail", student.mail)   # <-- added
...
# EMAIL_SENDER = "thirumahi65@gmail.com"           # <-- PUT YOUR GMAIL HERE
# EMAIL_APP_PASSWORD = "rewx fnfo jqou ppxw"     # Gmail App Password
...
#     rollno = db.Column(db.Integer)
#     phone = db.Column(db.String(20))
#     mail = db.Column(db.String(50))   # <-- FIXED
...
#                         # WHATSAPP (NO CHANGE)
#                         # ----------------------
#                         log_wh = MessageLog.query.filter_by(
#                             student_name=name,
#                             date=today_str,
#                             period=period,
#                             type="whatsapp"
...
#                         if not log_wh and student and student.phone:
#                             raw = student.phone.strip()
#                             digits = ''.join(ch for ch in raw if ch.isdigit())
#                             phone = f"+91{digits}" if len(digits) == 10 else raw
...
#                         # VOICE (NO CHANGE)
#                         # ----------------------
#                         log_voice = MessageLog.query.filter_by(
#                             student_name=name,
#                             date=today_str,
#                             period=period,
#                             type="voice"
